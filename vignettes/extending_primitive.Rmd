...
<!-- we should use consistent names: peek_naxes() and peek_shape(); Also, do we even need naxes and shape if we implement the generics for the R values (numeric and logical)?-->
