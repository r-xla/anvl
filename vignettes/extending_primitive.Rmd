...
Committing each to its own default would make `prim_add(1, nv_scalar(2, "f64"))` an error -- the literal would become `f32` and meet an `f64` -- where it should give `f64`.
