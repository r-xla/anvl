...
either a scalar or exactly the sample's shape. They are brought to the
sample's data type, so an `sd` that would have to narrow to reach it is an
error -- here `sds` and the sample share the default float, so nothing has to
move:
