...
{anvl} arrays implement most of base R's generic functions individually (`sqrt()`, `sum()`, `&`, ...) and mean what they mean in base R; `?"anvl-generics"` lists the places where they deliberately do not.
