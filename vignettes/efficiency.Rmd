...
If you do want `f64` throughout, set it once rather than annotating every value: `options(anvl.default_float = "f64")`, or `with_default_dtypes(c(float = "f64"), ...)` for a single scope.
