...
A handful of linear-algebra primitives -- `nv_svd()`, `nv_eigen()`, `nv_qr()`, `nv_lu()` -- use R's BLAS / LAPACK on the CPU backend, so the performance of these operations is determined by how R was built.
