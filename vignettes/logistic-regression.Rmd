...
Here, `X` naturally lands on the default floating point type because it is a `double`.
Because `y` is an integer, we explicitly request it to assume the default float type.
