...
# `jit_dispatcher()` is anvl's own accessor for the dispatcher of the active
# backend; a jitted function holds one implementation per backend.
# `cache_size()` is the same thing but reports 0 for a backend it never ran on.
