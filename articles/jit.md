...
[`jit()`](https://r-xla.github.io/anvl/reference/jit.md) breaks the
...
[`jit()`](https://r-xla.github.io/anvl/reference/jit.md) records into
the graph is `prim_*` calls.
...
is chosen for a
[`jit()`](https://r-xla.github.io/anvl/reference/jit.md)-compiled call
depends on how you called
...
[`help(jit)`](https://r-xla.github.io/anvl/reference/jit.md) for more
information.
