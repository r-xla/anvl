...
- Better composability:
  [`jit()`](https://r-xla.github.io/anvl/reference/jit.md)ted functions
  can now be used in other
  [`jit()`](https://r-xla.github.io/anvl/reference/jit.md)-calls. This
  is the mechanism underlying the new *eager mode*.
...
- An experimental [{quickr}](https://github.com/t-kalinowski/quickr)
  ...
  [`jit()`](https://r-xla.github.io/anvl/reference/jit.md) and
  [`nv_array()`](https://r-xla.github.io/anvl/reference/AnvlArray.md) or
  via the `anvl.default_backend` option.
- New primitives:
...
- New API functions (+ corresponding R generic implementations):
  - [`nv_diag()`](https://r-xla.github.io/anvl/reference/nv_diag.md) to
    create a diagonal matrix from a 1-D tensor.
  - [`nv_eye()`](https://r-xla.github.io/anvl/reference/nv_eye.md) to
  ...
  - [`nv_device()`](https://r-xla.github.io/anvl/reference/nv_device.md)
    ...
    constructors like
    [`nv_fill()`](https://r-xla.github.io/anvl/reference/nv_fill.md) or
  ...
  - [`nv_tril()`](https://r-xla.github.io/anvl/reference/nv_tril.md) and
    [`nv_triu()`](https://r-xla.github.io/anvl/reference/nv_triu.md) to
  ...
  - [`nv_log2()`](https://r-xla.github.io/anvl/reference/nv_log2.md) and
  ...
  - [`nv_sd()`](https://r-xla.github.io/anvl/reference/nv_sd.md) and
    [`nv_var()`](https://r-xla.github.io/anvl/reference/nv_var.md) for
    standard deviation and variance.
- [`jit()`](https://r-xla.github.io/anvl/reference/jit.md) now accepts
  integer positions for the `static` argument.
...
- Printing tensors via
  [`nv_print()`](https://r-xla.github.io/anvl/reference/nv_print.md) now
  also works on GPUs.
